...
parse.add_argument('file_path_in',
				   help='Input path or file')
parse.add_argument('file_path_out',
				   help='Output path or file')
parse.add_argument('-d','--delimiter-in',
				   default=D_DELIMITER,
				   help='Delimiter at INPUT, default is newline')
parse.add_argument('-dd','--delimiter-out',
				   default=D_DELIMITER,
				   help='Delimiter at OUTPUT, default is newline')
